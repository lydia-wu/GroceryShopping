...
| Metric | Value |
|--------|-------|
| **Total Meals** | 6 recipes |
| **Total Servings** | 39 servings |
| **Total Cost** | ~$176 ($4.51/serving) |
| **Timeline** | 14 days |
...
|------------|--------|
| Chicken breast | 2 packages |
| Kale | 2 bunches (half raw, half for pesto) |
| Sweet potato | 3 |
| Pearl barley | 1¾ cups |
...
- Beef Tallow - $13.99
- Org Avocado Cups - $9.99
- Bread Flour King Arthur (10 lb) - $8.99

**H-Mart - $17.29**
- Curly Parsley - $0.99
- Dill - $3.60
- Green Kale (3 bunches) - $5.37
- Chinese Eggplant - $0.77
- Purple Potato - $2.94
- Lime - $0.87
- Zucchini Squash - $2.02
- American Cucumber - $0.73
...
- Servings: 6 → 8
- Added kale pesto ingredients (parsley, parmesan, honey)
- Added chicken marinade (lemon juice, maple syrup, garlic powder, olive oil)
- Added spices (rosemary, thyme)
- Kale: 1 → 2 bunches
- Barley: 2 cups → 1¾ cups
- Added maple syrup and extra kale to Trip 2 shopping list

**January 9, 2026** - Integrated actual purchase data from Jan 8 shopping trip
